Shader "ustom/Research/Gloss Map" {
	...
	SubShader {
		Pass {
			...
			uniform float4 _EmitMap_ST; // Scale and Offset
			...
			float4 frag (vertexOutput i): COLOR {
				...
				// Final Light
				float3 lightFinal = diffuseReflection + (specularReflection * tex.a) + rimLightning + (_EmitColor * texE.rgb * _EmitStrength);
