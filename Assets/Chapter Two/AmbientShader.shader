...
Shader "Custom/Research/Ambient" {
	...
	SubShader {
		...
		Pass {
			...
			vertexOutput vert(vertexInput v) {
				...
				// Adding the Ambient Color from the Project Settings
				// This reference is created by Unity.
				// Why the plus instead of *? Because we want to ADD that color, and not tint it
				// When the light hit the object, we blend the light color + the object color
				// But the ambient light it's light it just striked alredy the object
